/* The following code was generated by JFlex 1.4.3 on 15-1-2 下午4:24 */
 ...
 * on 15-1-2 下午4:24 from the specification file
 * <tt>/home/lxw/workspace/CPAchecker/src/org/sosy_lab/cpachecker/cpa/automaton/Scanner.jflex</tt>
 */
class AutomatonScanner implements java_cup.runtime.Scanner, AutomatonSym {
  ...
  private Path getFile(String pYytext) throws FileNotFoundException {
    ...
    if (!file.isAbsolute()) {
      ...
      file = Paths.get(currentFile.getParent().toFile().getPath(), file.toFile().getPath());
    }
  ...
  private Location getStartLocation() {
    return new Location(filesStack.peek().toFile().getPath(), yyline+1,yycolumn+1-yylength());
  }

  private Location getEndLocation() {
    return new Location(filesStack.peek().toFile().getPath(), yyline+1,yycolumn+1);
  }
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 58:
          ...
          if (file != null) {
            yypushStream(new FileReader(file.toFile()));
          }
          }
        case 93: break;
        case 51:
        ...
        default:
          if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
            ...
            zzDoEOF();
              {
                if (yymoreStreams()) { yypopStream(); filesStack.pop(); } else {
