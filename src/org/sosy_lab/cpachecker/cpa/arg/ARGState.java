...
public class ARGState extends AbstractSingleWrapperState implements Comparable<ARGState>, Graphable {
  ...
  private boolean mycover = true;
  private boolean isEnd = false;
  private BooleanFormula sf = null;
  private int symPFLen = 0;
  private int braLen = 0;
  private boolean sameE=false;
  private boolean sameS=false;
  private boolean notCoveredBy=false;
  private int myCond=0;
  /*start for debugging*/
  private int draw=1;
  private boolean donotCover=false;



  public boolean isDonotCover() {
    return donotCover;
  }



  public void setDonotCover(boolean pDonotCover) {
    donotCover = pDonotCover;
  }
  ...
  public void setMyCond(int pMyCond) {
    myCond = pMyCond;
  }



  public boolean isMycover() {
    return mycover;
  }



  public void setMycover(boolean pMycover) {
    mycover = pMycover;
  }



  public int getBraLen() {
    return braLen;
  }



  public void setBraLen(int pBraLen) {
    braLen = pBraLen;
  }
  ...
  public void setHalf(boolean pHalf) {
    half = pHalf;
  }
  ...
  public void setReached(boolean pReached) {
    reached = pReached;
  }
  ...
  public BooleanFormula getSf() {
    return sf;
  }


  public void setSf(BooleanFormula pSf) {
    sf = pSf;
  }


  public int getSymPFLen() {
    return symPFLen;
  }


  public void setSymPFLen(int pSymPFLen) {
    symPFLen = pSymPFLen;
  }


  public boolean isSameE() {
    return sameE;
  }


  public void setSameE(boolean pSameE) {
    sameE = pSameE;
  }
  ...
  public void setSameS(boolean pSameS) {
    sameS = pSameS;
  }
  ...
  public void setNotCoveredBy(boolean pNotCoveredBy) {
    notCoveredBy = pNotCoveredBy;
  }
